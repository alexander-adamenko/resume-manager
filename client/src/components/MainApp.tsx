  ...
  return (
    <>
      <Router>
        ...
        <div className="container-fluid flex-grow-1">
          <Switch>
            ...
            <PrivateRoute
                ...
                username={username}
                setUsername={setUsername}
                exact path="/vacancies/:id/"
                render={(props: RouteComponentProps) => (
                    <VacancyComponent history={props.history} location={props.location} match={props.match} />
                )}
            />
            <PrivateRoute
                isLoggedIn={isLoggedIn}
        ...
        <footer className="bg-dark border-dark text-center bottom" style={{bottom:'0', width: '100%'}}>
